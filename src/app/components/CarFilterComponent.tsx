...
export default function CarFilterComponent({ onFiltersChange, initialFilters = {} }: CarFilterComponentProps) {
  ...
  const mileageOptions: FilterOption[] = [
    { value: '0-25000', label: '0 - 25,000 miles' },
    { value: '25000-50000', label: '25,000 - 50,000 miles' },
    { value: '50000-100000', label: '50,000 - 100,000 miles' },
    ...
    <div className="w-full max-w-7xl mx-auto p-6 bg-gray-50 rounded-xl mb-8">
      ...
      <div className="mt-4 flex justify-center gap-4">
        <button
          ...
          className="px-6 py-2 bg-gray-200 text-gray-700 font-medium text-sm rounded-lg hover:bg-gray-300 transition-colors focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2"
        >
          Clear Filters
        </button>
      </div>
